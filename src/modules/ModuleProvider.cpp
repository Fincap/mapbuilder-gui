...
void ModuleProvider::loadCoreModules()
{
  ...
  // Canvas
  loadedModules_["canvas"] = ManualInfo<mbc::Canvas, CanvasHandle>("Canvas",
...
mbc::PipelineStage::GENERATION
  ...
  // Perlin Noise
  loadedModules_["perlin_gen"] = ManualInfo<mbc::PerlinGen, PerlinGenHandle>("Perlin Noise",
  ...
  // Elevation slope
  loadedModules_["elevation_slope"] = ManualInfo<mbc::ElevationSlope, ElevationSlopeHandle>("Elevation Slope",
    "TODO - complete description",
  ...
  // BMP8Out
  loadedModules_["bmp8_out"] = ManualInfo<mbc::BMP8Out, BMP8OutHandle>("8-bit .bmp file",
    "TODO - complete description",
